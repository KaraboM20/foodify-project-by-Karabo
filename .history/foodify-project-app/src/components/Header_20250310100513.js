  ...
  return (
    <div className='header'>
      ...
      <div className="header_option">
          <NavLink activeClassName to='/favourites'><span className='header-option1'><FaRegHeart title="Favourites" />Favourites</span></NavLink>
          <Link to='/notifications'><span className='header-option2'><IoMdNotificationsOutline title="notification"/>Notifications</span></Link>
          <Link to='/cartspage'><span className='header-option3'><IoCartOutline title="cart"/>Cart</span>  </Link>
     </div>
    </div>
  );
};
