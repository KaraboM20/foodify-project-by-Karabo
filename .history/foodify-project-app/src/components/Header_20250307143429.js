  ...
  return (
    <div className='header'>
      ...
      <div className="header_option">
          <span className='header-option1 nav-icon'><FaRegHeart title="Favorite" />Favourites</span>
          <span className='header-option2 nav-icon'><IoMdNotificationsOutline title="notification"/>Notifications</span>
          <span className='header-option3 nav-icon'><IoCartOutline title="cart"/>Cart</span>  
     </div>
    </div>
  );
};
